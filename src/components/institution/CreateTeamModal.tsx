...
export function CreateTeamModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="relative bg-gradient-to-br from-gray-800/95 via-black/90 to-gray-900/95 rounded-lg shadow-2xl border border-gray-700 max-w-md w-full p-6">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <p className="text-gray-400 mb-6">Agregar un equipo al programa de {sportName}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <button
                ...
                className={`relative px-4 py-3 rounded-lg border transition-all overflow-hidden group ${
                  genderCategory === 'male'
              ...
              >
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="text-xs font-medium">Hombres</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="text-xs font-medium">Mujeres</span>
                </div>
              </button>
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="flex-1 px-4 py-3 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium"
            >
              Cancelar
            </button>
            <button
              ...
              className="flex-1 px-4 py-3 bg-[#e21c21] hover:bg-[#c11a1e] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium"
            >
